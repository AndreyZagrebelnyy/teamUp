...
const arenaDateRoutes = require("./api/arenaDate.routes");
const arenaRoutes = require("./api/arena.routes");
const favouriteRoutes = require("./api/favourite.routes");
const favouriteArenaRoutes = require("./api/favouriteArena.routes");
...
router.use("/favouriteArenas", favouriteArenaRoutes);
router.use("/dates", dateRoutes);
router.use("/arenaDates", arenaDateRoutes);
